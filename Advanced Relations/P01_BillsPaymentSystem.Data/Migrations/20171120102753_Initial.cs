...
namespace P01_BillsPaymentSystem.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_Id_CreditCardId_BankAccountId",
                table: "PaymentMethods",
                columns: new[] {"Id", "CreditCardId", "BankAccountId"},
                unique: true);

            migrationBuilder.Sql(@"ALTER TABLE PaymentMethods
            ADD CONSTRAINT CK_CreditCardId_BankAccountId
            CHECK((CreditCardId IS NULL AND BankAccountId IS NOT NULL)OR(CreditCardId IS NOT NULL AND BankAccountId IS NULL))");
        }
